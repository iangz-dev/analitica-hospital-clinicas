...
tipo_alta_19=base_int_19%>%select(`TIPO ALTA`)%>%table()
...
# reinte_19[,2]=sweep(reinte_19[,2],MARGIN = 1,STATS = 1,"-")



##reinte_19 = reinte_19[reinte_19$Total != 0, ]
...
reinte_19=as.data.frame(aux_rei_19)
...
## Relación entre mortalidad, reinternacion y duración de la internación por servicio con geom_text
...
b4<-b3%>%dplyr::select(AREA,Porc_Mort_19,Porc_Mort_20,
